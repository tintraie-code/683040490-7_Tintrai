...
class RegistrationApp:
    ...
    def create_form_fields(self):
        ...
        ttk.Entry(form_frame, textvariable=self.name_var, width=50).pack(anchor='w', pady=2)

        ttk.Label(form_frame, text="Email:").pack(anchor='w', pady=(10, 0))
        ttk.Entry(form_frame, textvariable=self.email_var, width=50).pack(anchor='w', pady=2)

        ttk.Label(form_frame, text="Phone:").pack(anchor='w', pady=(10, 0))
        ttk.Entry(form_frame, textvariable=self.phone_var, width=50).pack(anchor='w', pady=2)
        ...
        for gender in ["Male", "Female", "Non-binary", "Prefer not to say"]:
            ttk.Radiobutton(
                gender_frame,
                text=gender,
        ...
        program_options = ["Computer Science", "Engineering", "Business", "Arts", "Sciences"]
        ttk.Combobox(
            form_frame,
        ...
        self.story_text = tk.Text(form_frame, height=4, width=50)
        self.story_text.pack(anchor='w', pady=2)
    ...
    def show_confirmation_page(self):
        ...
        for label_text, value_text in fields:
            ...
            ttk.Label(row, text=label_text, font=("Helvetica", 10, "bold"), width=15).pack(side='left')
            ttk.Label(row, text=value_text).pack(side='left')
